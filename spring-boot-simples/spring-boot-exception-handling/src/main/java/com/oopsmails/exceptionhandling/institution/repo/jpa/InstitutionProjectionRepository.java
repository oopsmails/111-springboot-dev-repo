...
public interface InstitutionProjectionRepository extends JpaRepository<Institution, Long> {
    ...
    @Query("SELECT i.id AS institutionId, b.id AS branchId, i.institutionName AS institutionName, i.description AS description FROM Institution i JOIN i.branchList b")
    ...
    @Query("SELECT i.id AS institutionId, b.id AS branchId, b.branchName AS branchName, i.institutionName AS institutionName, i.description AS description FROM Institution i JOIN i.branchList b WHERE i.id = :institutionId")
