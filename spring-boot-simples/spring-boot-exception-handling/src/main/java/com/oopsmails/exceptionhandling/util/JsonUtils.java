...
//    public static String PROJECT_PATH = "/data/";
    ...
    public static void printJsonObject(String addingMessage, Object obj) {
        System.out.println(objectToJson(addingMessage, obj));
    }
    ...
    public static String objectToJson(String addingMessage, Object obj) {
        ...
        return (added + "- <Albert> logging object: " + prettyJsonStr);
    }
