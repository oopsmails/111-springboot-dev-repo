...
public class SSLMutualAuthMain {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Call a SSL-endpoint
            callEndPoint(client, "https://secure.server.com/endpoint", "?param1=value1"
                    //            new JSONObject()
                    //                    .put("param1", "value1")
                    //                    .put("param2", "value2")
            );
    ...
    private static void callEndPoint(CloseableHttpClient aHTTPClient, String aEndPointURL, String jsonObject) {
        try {
