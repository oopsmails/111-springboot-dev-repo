 ...
 */
package com.oopsmails.avro.dto;
...
public class PersonDto extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3236156335923014069L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PersonDto\",\"namespace\":\"com.oopsmails.avro.dto\",\"fields\":[{\"name\":\"firstName\",\"type\":\"string\",\"doc\":\"the first name of a person\"},{\"name\":\"lastName\",\"type\":\"string\",\"doc\":\"the last name of a person\"}]}");
   ...
   */
  public static com.oopsmails.avro.dto.PersonDto.Builder newBuilder() {
    return new com.oopsmails.avro.dto.PersonDto.Builder();
  }
   ...
   * @return A new PersonDto RecordBuilder
   */
  public static com.oopsmails.avro.dto.PersonDto.Builder newBuilder(com.oopsmails.avro.dto.PersonDto.Builder other) {
    if (other == null) {
      return new com.oopsmails.avro.dto.PersonDto.Builder();
    } else {
      return new com.oopsmails.avro.dto.PersonDto.Builder(other);
    }
  }
   ...
   * @return A new PersonDto RecordBuilder
   */
  public static com.oopsmails.avro.dto.PersonDto.Builder newBuilder(com.oopsmails.avro.dto.PersonDto other) {
    if (other == null) {
      return new com.oopsmails.avro.dto.PersonDto.Builder();
    } else {
      return new com.oopsmails.avro.dto.PersonDto.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PersonDto>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.oopsmails.avro.dto.PersonDto.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.oopsmails.avro.dto.PersonDto other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.firstName)) {
        this.firstName = data().deepCopy(fields()[0].schema(), other.firstName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.oopsmails.avro.dto.PersonDto.Builder setFirstName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.oopsmails.avro.dto.PersonDto.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.oopsmails.avro.dto.PersonDto.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.oopsmails.avro.dto.PersonDto.Builder clearLastName() {
      lastName = null;
